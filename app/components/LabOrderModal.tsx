        ...
        <div className="px-5 pt-3 pb-1.5 flex-shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-9 pr-3 py-2.5 text-[12px] font-semibold outline-none transition focus:border-amber-400 focus:bg-white"
              autoFocus
            />
            {search && (
              <button
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-1.5">
                                ...
                                {test.needsPricing && (
                                  <span className="flex-shrink-0 rounded bg-amber-100 px-1.5 py-0.5 text-[7px] font-extrabold uppercase tracking-wider text-amber-700">
                                    Needs Pricing
                                  </span>
                                )}
                              </div>
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                {test.defaultPrice > 0 && (
                                  <span className="text-[9px] text-slate-500 font-semibold">
                                    UGX {test.defaultPrice.toLocaleString("en-UG")}
                                  </span>
                                )}
                              </div>
                            </div>
        ...
        <div className="border-t border-slate-100 px-5 py-3.5 flex items-center justify-between flex-shrink-0 bg-slate-50/50">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-amber-500 px-5 py-2 text-[10px] font-extrabold uppercase tracking-wider text-white hover:bg-amber-600 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
            >
              {confirming ? (
                <>
